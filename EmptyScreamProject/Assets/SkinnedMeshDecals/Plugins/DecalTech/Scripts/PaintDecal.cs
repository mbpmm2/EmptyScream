...
public class PaintDecal : MonoBehaviour {
    ...
    public RenderTexture RenderDecal(Renderer r, Texture decal, Vector3 position, Quaternion rotation, Color color, float size = 1f, float depth = 2f, bool addPadding = true) {
